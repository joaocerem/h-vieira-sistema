ALTER TABLE lancamentos_financeiros ADD CONSTRAINT fk_lancamentos_financeiros_empresa FOREIGN KEY (empresa_id) REFERENCES empresas (id) ON DELETE RESTRICT;
...
ALTER TABLE contas_bancarias ADD CONSTRAINT fk_contas_bancarias_empresa FOREIGN KEY (empresa_id) REFERENCES empresas (id) ON DELETE RESTRICT;

ALTER TABLE cartoes_credito ADD CONSTRAINT fk_cartoes_credito_conta_bancaria FOREIGN KEY (conta_bancaria_id) REFERENCES contas_bancarias (id) ON DELETE RESTRICT;

ALTER TABLE liquidacoes_financeiras ADD CONSTRAINT fk_liquidacoes_financeiras_conta_bancaria FOREIGN KEY (conta_bancaria_id) REFERENCES contas_bancarias (id) ON DELETE RESTRICT;
...
ALTER TABLE compras_cartao ADD CONSTRAINT fk_compras_cartao_cartao FOREIGN KEY (cartao_id) REFERENCES cartoes_credito (id) ON DELETE RESTRICT;
...
ALTER TABLE faturas ADD CONSTRAINT fk_faturas_cartao FOREIGN KEY (cartao_id) REFERENCES cartoes_credito (id) ON DELETE RESTRICT;
...
ALTER TABLE contratos_financeiros ADD CONSTRAINT fk_contratos_financeiros_conta_bancaria FOREIGN KEY (conta_bancaria_id) REFERENCES contas_bancarias (id) ON DELETE RESTRICT;
...
ALTER TABLE veiculos ADD CONSTRAINT fk_veiculos_obra_atual FOREIGN KEY (obra_atual_id) REFERENCES obras (id) ON DELETE RESTRICT;
...
ALTER TABLE acoes_propostas_ia ADD CONSTRAINT fk_acoes_propostas_ia_empresa FOREIGN KEY (empresa_id) REFERENCES empresas (id) ON DELETE RESTRICT;
